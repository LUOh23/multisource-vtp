...
ax.semilogx(vertices, max_error, 's--', color='#D98736', lw=2.0, ms=8,
            ...
            label=r'$\varepsilon_{\max}$ (Max Error)', zorder=5)
# Mean Error
ax.semilogx(vertices, mean_error, 'o-', color='#C00000', lw=2.5, ms=8,
            ...
            label=r'$\bar{\varepsilon}$ (Mean Error)', zorder=5)

# Annotations
ax.annotate('Min: 0.05% @ 6,242 vertices', xy=(6242, 0.05), xytext=(14000, 0.7),
...
ax.annotate('Coarse mesh: 3.35%', xy=(50, 3.35), xytext=(120, 5.8),
            arrowprops=dict(arrowstyle='->', color='#D98736', lw=1.0),
            fontsize=8.5, color='#B8651A', zorder=10)
ax.annotate('Finest: 0.12%', xy=(32042, 0.12), xytext=(8000, 1.5),
...
plt.tight_layout()
plt.savefig('output/fig3_heat_error.png', dpi=600,
